#' @title JobInfo dataset
#'
#' @description The data was extracted from the Indeed website, and comprises salary and 22 related variables.
#'
#' @format A data frame with 645 observations on 23 variables.
#' \describe{
...
#' }
#'
#' @source Scraping from Indeed website
#'
#' @examples
#' summary(tidy_data)
#'
